...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/istkharalam62/banarashi",
)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv(
    "GIT_TOKEN", None
)  
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Dil_ki_baate_shayari")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/Dil_ki_baate_shayari")
